...
function particleInit(){
	...
	part_type_color1(global.Particle1,c_red);                  //This sets its colour. Th	ere are three different codes for this
	...
	part_type_orientation(global.Particle1,0,0,0,0,false);        //This changes the rotation of the particle
	part_type_blend(global.Particle1,0);                         //This is the blend mode, either additive or normal
	part_type_life(global.Particle1,20,3);                       //this is its lifespan in steps</pre>
